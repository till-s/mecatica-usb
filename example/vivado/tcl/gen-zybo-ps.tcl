set ps7_module_name_var processing_system7_0

if { [llength [get_ips ${ps7_module_name_var}]] == 0 } {
    create_ip -name processing_system7 -vendor xilinx.com -library ip -module_name ${ps7_module_name_var}
    # Generated from digilent board_files
    # 1. install board files
    # 2. from vivado tcl console (no project) set_param board.repoPaths <path>
    # 3. create project, select board
    # 4. *create block design*
    # 5. add processing system
    # 6. click *block automation* with 'use board presets' selected
    # 7. save configuration
    # !! NOTE !!:
    #  - 'import XPS with the zybo 'preset.xml'' did not do anything.
    #  - the warnings regarding negative DDR delays may be ignored
    #    (see zybo-z7 hardware errata)
    #
    # UPDATE - the board file was too far from the old generic system, so I revived that one,
    #          hoping it's closer to the current UBOOT ps-7
    # ONE MORE THING: watch out (and remove) this setting which will pull-in overriding settings!
