...
*******************************************************************************/
(* ORIG_MODULE_NAME="UlpiPLL", LATTICE_IP_GENERATED="1" *) module UlpiPLL (clki_i, 
        rstn_i, 
        clkop_o, 
        clkos_o, 
        lock_o) ;
    ...
    output clkos_o ; 
    output lock_o ; 
    UlpiPLL_ipgen_lscc_pll #(.INTFBKDEL_SEL("DISABLED"),
...
// Module : lscc_pll
//==========================================================================
module UlpiPLL_ipgen_lscc_pll #(parameter FVCO = 800.0, 
    ...
    generate
        if ((APB_EN == 1)) 
            begin : gen_apb
                ...
                ///
                UlpiPLL_ipgen_lscc_apb2lmmi #(.DATA_WIDTH(8),
                        .ADDR_WIDTH(8),
                ...
                if (APB_SOFT_REG_EN) 
                    begin : gen_csr
                        wire unused_w ; 
                        UlpiPLL_ipgen_pll_csr u_csr (// Inputs
                                .clk_i(apb_pclk_i), 
                                    .rst_n_i(apb_preset_n_i), 
...
// Module : pll_csr
//==========================================================================
(* LATTICE_IP_MODULE=1 *) module UlpiPLL_ipgen_pll_csr #(parameter SIMULATION = 0) (
    //--begin_param--
    //----------------------------
    // Parameters
    //----------------------------
...
//==========================================================================
module UlpiPLL_ipgen_lscc_apb2lmmi #(parameter DATA_WIDTH = 32, 
