...
set_input_delay -clock ulpiClk -min -add_delay 0.000 [all_fanin -flat -startpoints_only [get_pins -hier -regex {.*/din_r_reg[[][0-7][]]/D}]]
set_input_delay -clock ulpiClk -min -add_delay 0.000 [all_fanin -flat -startpoints_only [get_pins -hier -regex .*/nxt_r_reg/D]]
set_input_delay -clock ulpiClk -min -add_delay 0.000 [all_fanin -flat -startpoints_only [get_pins -hier -regex .*/dir_r_reg/D]]

# set the max. input delay to
# max(data_trace_delay + clock_trace_delay) + max. delay when data source is valid after active clock

set_input_delay -clock ulpiClk -max -add_delay 7.50 [all_fanin -flat -startpoints_only [get_pins -hier -regex {.*/din_r_reg[[][0-7][]]/D}]]
set_input_delay -clock ulpiClk -max -add_delay 7.50 [all_fanin -flat -startpoints_only [get_pins -hier -regex .*/nxt_r_reg/D]]
set_input_delay -clock ulpiClk -max -add_delay 7.50 [all_fanin -flat -startpoints_only [get_pins -hier -regex .*/dir_r_reg/D]]
...
set_output_delay -clock ulpiClk -min -add_delay -0.2500 [all_fanout -flat -endpoints_only [get_pins -hier -regex {.*/dou_r_reg[[][0-7][]]/Q}]]
set_output_delay -clock ulpiClk -max -add_delay 3.250 [all_fanout -flat -endpoints_only [get_pins -hier -regex {.*/dou_r_reg[[][0-7][]]/Q}]]

set_output_delay -clock ulpiClk -min -add_delay -0.2500 [all_fanout -flat -endpoints_only [get_pins -hier -regex .*/stp_r_reg/Q]]
set_output_delay -clock ulpiClk -max -add_delay 3.250 [all_fanout -flat -endpoints_only [get_pins -hier -regex .*/stp_r_reg/Q]]
