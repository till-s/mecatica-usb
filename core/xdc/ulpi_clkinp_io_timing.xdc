...
set_input_delay -add_delay -clock ulpiClk -max 7.500 [all_fanin -flat -startpoints_only [get_pins -hier -regex {.*/din_r_reg[[]0[]]/D}]]
set_input_delay -add_delay -clock ulpiClk -max 7.500 [all_fanin -flat -startpoints_only [get_pins -hier -regex {.*/din_r_reg[[]1[]]/D}]]
set_input_delay -add_delay -clock ulpiClk -max 7.500 [all_fanin -flat -startpoints_only [get_pins -hier -regex {.*/din_r_reg[[]2[]]/D}]]
set_input_delay -add_delay -clock ulpiClk -max 7.500 [all_fanin -flat -startpoints_only [get_pins -hier -regex {.*/din_r_reg[[]3[]]/D}]]
set_input_delay -add_delay -clock ulpiClk -max 7.500 [all_fanin -flat -startpoints_only [get_pins -hier -regex {.*/din_r_reg[[]4[]]/D}]]
set_input_delay -add_delay -clock ulpiClk -max 7.500 [all_fanin -flat -startpoints_only [get_pins -hier -regex {.*/din_r_reg[[]5[]]/D}]]
set_input_delay -add_delay -clock ulpiClk -max 7.500 [all_fanin -flat -startpoints_only [get_pins -hier -regex {.*/din_r_reg[[]6[]]/D}]]
set_input_delay -add_delay -clock ulpiClk -max 7.500 [all_fanin -flat -startpoints_only [get_pins -hier -regex {.*/din_r_reg[[]7[]]/D}]]
...
# use -quiet for stp_i since this signal is only used when MARK_DEBUG is enabled
set_input_delay -quiet -add_delay -clock ulpiClk -max 7.500 [all_fanin -quiet -flat -startpoints_only [get_pins -quiet -hier -regex .*/stp_i_reg/D]]
...
set_output_delay -add_delay -clock ulpiClk -max 4.000 [all_fanout -flat -endpoints_only [get_pins -hier -regex {.*/dou_r_reg[[]0[]]/Q}]]
set_output_delay -add_delay -clock ulpiClk -max 4.000 [all_fanout -flat -endpoints_only [get_pins -hier -regex {.*/dou_r_reg[[]1[]]/Q}]]
set_output_delay -add_delay -clock ulpiClk -max 4.000 [all_fanout -flat -endpoints_only [get_pins -hier -regex {.*/dou_r_reg[[]2[]]/Q}]]
set_output_delay -add_delay -clock ulpiClk -max 4.000 [all_fanout -flat -endpoints_only [get_pins -hier -regex {.*/dou_r_reg[[]3[]]/Q}]]
set_output_delay -add_delay -clock ulpiClk -max 4.000 [all_fanout -flat -endpoints_only [get_pins -hier -regex {.*/dou_r_reg[[]4[]]/Q}]]
set_output_delay -add_delay -clock ulpiClk -max 4.000 [all_fanout -flat -endpoints_only [get_pins -hier -regex {.*/dou_r_reg[[]5[]]/Q}]]
set_output_delay -add_delay -clock ulpiClk -max 4.000 [all_fanout -flat -endpoints_only [get_pins -hier -regex {.*/dou_r_reg[[]6[]]/Q}]]
set_output_delay -add_delay -clock ulpiClk -max 4.000 [all_fanout -flat -endpoints_only [get_pins -hier -regex {.*/dou_r_reg[[]7[]]/Q}]]
